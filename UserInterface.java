...
public class UserInterface {
   ...
   // private ArrayList<Recipe> recipesReadFromFile;
    ...
    public void start() {
        ...
        String finalRecipeName = breakingIntoIndividualRecipes.get(0);
        int finalRecipetime = Integer.valueOf(breakingIntoIndividualRecipes.get(1));
        ArrayList<String> ingredients = new ArrayList<>();
        for (int i = 2; i < breakingIntoIndividualRecipes.size(); i++) {
            ingredients.add(breakingIntoIndividualRecipes.get(i));
        }
       // Recipe recipe = new Recipe(finalRecipeName, finalRecipetime, ingredients);
        recipesReadFromFile.add(new Recipe(finalRecipeName, finalRecipetime, ingredients));
      //  breakingIntoIndividualRecipes.clear();
